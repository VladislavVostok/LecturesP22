...
{
    public DbSet<User> Users { get; set; } = null!;
    private readonly string? ConnectionString {set; get;}

    public ApplicationContext(string connectionString)
    {
        ConnectionString = connectionString;   // получаем извне строку подключения
...
// dotnet package add Microsoft.Extensions.Configuration.FileExtensions
