...
    {
		...
		optionsBuilder.UseSqlServer(@"Server=DESKTOP-T9QBO67;User ID=sa;Password=********;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;");
    }
...
- Trusted_Connection: устанавливает проверку подлинности window учетка.
