	...
	internal class Program
	{
		public static void Main(string[] args)
		{
			using (ApplicationDBContext db = new ApplicationDBContext())
			{
			    ...
			    db.Countries.AddRange(usa, canada, japan);
			    db.SaveChanges();
			
			    Company microsoft = new Company { Name = "Microsoft", Country = usa };
			    Company google = new Company { Name = "Google", CountryId = canada.Id };
			    Company sony = new Company { Name = "Sony", Country = japan };
			    db.Companies.AddRange(microsoft, google, sony);
			    db.SaveChanges();
			
			    User tom = new User { Name = "Tom", Company = microsoft, Position = manager };
			    User bob = new User { Name = "Bob", Company = google, Position = manager };
			    ...
			    User victor = new User { Name = "Victor", Company = sony, Position = developer };
			    User nikita = new User { Name = "Nikita", Company = sony, Position = developer };
			    db.Users.AddRange(tom, bob, alice, kate, victor, nikita);
			    db.SaveChanges();
			}
...
```sql
SELECT "u"."UserId", "u"."Age", "u"."CompanyId", "u"."IsMarried", "u"."Name", "u"."PositionId", "c"."Id", "c"."CountryId", "c"."Name", "c0"."Id", "c0"."CapitalId", "c0"."Name", "c1"."Id", "c1"."Name", "p"."Id", "p"."Name"
FROM "Users" AS "u"
LEFT JOIN "Companies" AS "c" ON "u"."CompanyId" = "c"."Id" --Include()
LEFT JOIN "Countries" AS "c0" ON "c"."CountryId" = "c0"."Id" -- IncludeThen()
LEFT JOIN "Cities" AS "c1" ON "c0"."CapitalId" = "c1"."Id" -- IncludeThen()
LEFT JOIN "Positions" AS "p" ON "u"."PositionId" = "p"."Id" --Include()
```
