...
Проект "Protondoro" - сервис по тайм-менеджменту реализующий технику Помодоро.
...
- **Фронтенд:** React версии 19  с TypeScript, Node.js для сборки
- **База данных:** PostgreSQL
- **Аутентификация:** JWT Tokens, oauth 2.0 ( github.com, vk.com и прочее.)
- **Стилизация:** CSS-фреймворк (Tailwind CSS) с поддержкой кастомных тем
...
- **Режим "Дзен"**: по нажатию кнопки скрывается весь интерфейс, кроме таймера и текущей задачи. Повторное нажатие — возврат.
...
CREATE TABLE UserTimerSettings (
    ...
    AutoartBreaks BOOLEAN DEFAULT FALSE,
    AutoStartPomodoros BOOLEAN DEFAULT FALSESt,
...
3. Создать миграции для основных таблиц (Users, Projects, Categories, Tasks) (Свои миграции)
...
- Использовать **Entity Framework Core** на бэкенде для работы с БД  (под вопросом)
